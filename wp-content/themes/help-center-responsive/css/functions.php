...
if (is_admin () && isset ( $_GET ['activated'] ) && $pagenow == 'themes.php') {
	...
	// post
	update_option ( 'faq_per_page', '6' );
	update_option('ppr_section', '9');
	update_option('ppr_topic', '9');
	update_option('ppr_search', '9');
	update_option ( 'ppr_front_faq', '3' );
...
function themeoptions_update() {
	...
	// post
	update_option ( 'faq_per_page', $_POST ['faq_per_page'] );
	update_option('ppr_section',  $_POST ['ppr_section']);
	update_option('ppr_topic',  $_POST ['ppr_topic']);
	update_option('ppr_search',  $_POST ['ppr_search']);
	update_option ( 'ppr_front_faq', $_POST ['ppr_front_faq'] );
}
