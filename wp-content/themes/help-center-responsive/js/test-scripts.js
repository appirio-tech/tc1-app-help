...
var app = {
    init: function() {
        ...
        $('body').on(ev, function() {
            ...
            $('.searchWidget:visible').hide();
            $('.headerTopRightMenuLink.search').removeClass("active");
            $('.searchTermInput').val("");
        });
        
        $('.userWidget, .searchWidget').on(ev, function(e) {
            e.stopPropagation();
        });
    ...
    initEvents: function() {
        ...
        $('.search a').on(ev, function() {
            var widg = $('.searchWidget', $(this).closest('.container'));
            if ($(this).hasClass('isActive')) {
                widg.stop().slideUp();
                $(this).removeClass('isActive');
                $('.headerTopRightMenuLink.search').removeClass("active");
                ...
                widg.stop().slideDown();
                $(this).addClass('isActive');
                $('.headerTopRightMenuLink.search').addClass("active");
            }
            return false;
        
        });
        $('.btnGoSearch').on(ev, function() {
            location.href =  wpUrl + "/search?s=" + $('.searchTermInput').val();
        });
